...
% proj_corner_coords = round(proj_corner_coords);
...
% blank_img = -ones(round(546), round(897));
% blank_img = uint8(blank_img)



% imshow(uint8(blank_img))
...
%         new_coords(1,1,j) = coord3(1,1);
%         pixel_color = inputImage(j,i,1:3);
%         coord1 = [i; j; 1];
%         coord2 = H_mat*coord1;
%         coord3 = round(coord2/coord2(3,1));
%         i_new = coord3(1,1);
%         j_new = coord3(2,1);
%         new_coords(1,1,j) = coord3(1,1);
%         new_coords(2,((i-1)*480)+640*j) = coord3(2,1)+26;
%         colors(1:3,((i-1)*480)+640*j) = pixel_color;
%         new_coords(5,((j-1)*480)+i) = pixel_color(2);
